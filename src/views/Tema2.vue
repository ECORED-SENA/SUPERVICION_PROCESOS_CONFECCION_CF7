...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    figure.mb-5
      img(src='@/assets/curso/tema_2/img_1.png', alt='Texto que describa la imagen')

    p Las acciones que están encaminadas a la conservación de los equipos, máquinas y herramientas, en las empresas de confección, son denominadas acciones de mantenimiento. También tienen que ver con restaurar artículos o elementos, y dejarlos a punto para cumplir sus funciones. 
    ...
    p.mb-5 Todas las actividades del mantenimiento deben quedar registradas, para poder hacer seguimiento y evaluar el impacto en la productividad y en el gasto de recursos.


    h5.text-center.mb-5 Para realizar el mantenimiento es importante:
    ...
    LineaTiempoD.color-primario
      .row(numero="1" titulo="Mantenimiento diario") 
        .col-lg-12
          ...
          .row.justify-content-center
            .col-lg-8
              p.BorTit.mb-4 #[strong Figura 20] #[br]Mantenimiento a máquinas
              figure
      ...
      .row(numero="2" titulo="Mantenimiento preventivo") 
        ...
        .row.justify-content-center
          .col-lg-11
            p.BorTit #[strong Figura 21] #[br]Ficha técnica de mantenimiento preventivo
            figure
      ...
      .row(numero="3" titulo="Mantenimiento correctivo")   
        ...
        .row.justify-content-center
          .col-lg-12
            p.BorTit #[strong Figura 22] #[br]Ficha técnica mantenimiento correctivo
            figure
